...
void printPause(uint8_t hex) {
    drawCorrect(0, 96, hex);
    drawCorrect(0, 100, hex);
    drawCorrect(1, 96, hex);
    drawCorrect(1, 100, hex);

    drawCorrect(3, 96, hex);
    drawCorrect(3, 100, hex);
    drawCorrect(4, 96, hex);
    drawCorrect(4, 100, hex);
}
